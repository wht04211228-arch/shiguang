...
export default function PrivacyPage() {
  return <LegalPage eyebrow="PRIVACY NOTICE" title="隐私与素材处理说明" updated="2026年7月13日">
    ...
    <section><h2>2. 使用目的</h2><p>信息仅用于账号登录、付款核对与订单履约、礼物制作、内容托管、售后支持、安全防护和匿名化转化分析。</p></section>
    <section><h2>3. 素材安全</h2><p>云端素材默认存放在私有存储中，通过短时签名地址访问。解锁答案以加盐哈希保存，服务端不会以明文存储答案。</p></section>
    <section><h2>4. 第三方服务</h2><p>根据配置，数据库、邮件、AI文案与部署可能由 Supabase、Resend、DeepSeek 和 Vercel 等服务商处理。人工付款凭证会存入私有云存储，仅供订单所有者查看审核状态及管理员核对。正式上线时应在此列明实际启用的供应商与地区。</p></section>
